...
En la clase 'Solicitud.java', el método 'asignarTecnico' contiene un condicional que lanza una excepción si el técnico no está activo. Esto es un "Code Smell" que podría crecer en complejidad si se añaden más validaciones en el futuro.
